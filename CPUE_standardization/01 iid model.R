...
pdf(paste0(out_01,"/01 iid model 1A_psy output", ix,".pdf"), 
    width = 8, height = 7, 
    bg = "white",         
    colormodel = "cmyk",    
    paper = "A4")          
...
## save
ggsave(paste0(out_01,"/01 iid model 1A_psy mean random effect", ix,".png"), dpi=300, 
       width=6, height=6)
...
## save
ggsave(paste0(out_01,"/01 iid model 1A_psy sd random effect", ix,".png"), dpi=300, 
       width=6, height=6)
...
## save
ggsave(paste0(out_01,"/01 iid model 1A_psy shape random effect", ix,".png"), dpi=300, 
       width=6, height=6)
...
## save
ggsave(paste0(out_01,"/01 iid model 1A_psy psyear RW2 effect", ix,".png"), dpi=300, 
       width=6, height=6)
...
## save
ggsave(paste0(out_01,"/01 iid model 1A_psy fitted CPUE sd", ix,".png"), dpi=300, 
       width=6, height=6)
...
## save
ggsave(paste0(out_01,"/01 iid model predicted CPUE index_1 area", ix,".png"), dpi=300, 
       width=6, height=6)
...
## save
ggsave(paste0(out_01,"/01 iid model predicted CPUE index_ 4 areas", ix,".png"), dpi=300, 
       width=6, height=6)
...
## save
ggsave(paste0(out_01, "/01 iid model predicted CPUE median (years collapsed)", ix,".png")
...
#       ggtitle(paste0(j))
#    
#    ggsave(paste0(out_011,"/predicted CPUE psyear", j, "_", ix, ".png"))
#    
# }
# 
# ## magick ----------------------------------------------------------------------
